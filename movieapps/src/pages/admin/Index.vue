      ...
      <q-card-section>
          ...
          >
            <template v-slot:body="props">
              <q-tr :props="props">
                <q-td key="judulMovie" :props="props">
                  {{ props.row.dataMovie[0].judulMovie }}
                </q-td>
        ...
        <q-card-section class="q-pt-none">
          <div class="row">
            ...
            <div class="col">
              ...
              <div class="text-weight-bold">
                {{activeData.dataMovie[0].judulMovie}}
              </div>
            </div>
            <div class="col">
              <div class="text-caption">
...
export default {
  ...
  data () {
    return {
      columns: [
        { name: 'judulMovie', align: 'center', label: 'Judul Movie', field: 'judulMovie', sortable: true },
