  ...
  <q-page padding>
        ...
        <div class="row">
          ...
          <div class="col">
            <q-banner inline-actions class="text-b;ue-grey-12">
              <div class="text-h6">INPUT DATA MOVIE</div>
              <div>Input Data Movie Baru</div>
            </q-banner>
          </div>
        </div>
      </div>
    ...
    <q-card>
      <q-card-section class="row">
        ...
        <q-input
            filled
            v-model="form.judulMovie"
            label="Judul Movie"
            :rules="[ val => val && val.length > 0 || 'Mohon isi Judul Movie']"
        />
        <q-input
            filled
            v-model="form.harga"
            type="number"
            label="Harga Rp."
            :rules="[ val => val  > 0 || 'Mohon isi Harga Movie']"
        />
        <q-input
            filled
            v-model="form.tahun"
