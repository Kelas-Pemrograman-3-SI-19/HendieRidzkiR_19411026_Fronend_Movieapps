    ...
    <q-page padding>
        <div class="q-mb-xl">
            ...
            <q-banner class="bg-dark">
              <div class=" text-orange text-h5">Daftar-daftar list Movie Terbaru Gaes !!!</div>
            </q-banner>
            ...
            <div class="col-md-3 col-xs-12" v-for="(movie, i) in data" :key="i">
                <q-card>
                    ...
                    />
                        ...
                        <q-card-actions>
                            <q-btn unelevated @click="openDetail(movie) " class="full-width" color="pink-10">
          ...
          <q-dialog v-model="dialog" v-if="dialog" position="left">
            <q-card style="width: 500px">
              ...
              <q-card-section style="max-height: 50vh;" class="scroll">
                   <div class="text-bold text-h6">{{ activeData.judulMovie }}</div> Dengan Harga Rp.{{ activeData.harga}},-
